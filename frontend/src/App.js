    ...
    <Router>
      ...
      <div className="container main">
        <Routes>
          ...
          <Route exact path="/bookmarked" element={<Recepies message="No results found. Bookmark a post." filter={`bookmark__owner__profile=${profile_id}&ordering=-bookmark__created_at&`} />} />
